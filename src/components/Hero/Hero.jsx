                ...
                {data.map((item, index) => (
                    <div key={index} className='flex flex-col md:flex-row justify-between items-center w-full max-w-[1440px] gap-8'>
                        <div className='w-full md:w-[48%] lg:w-[50%] text-center md:text-left'>
                            ...
                            {/*'https://drive.google.com/file/d/1AinAiisk3Pbl_rOqePd46NJpsiDaWOGl/view?usp=sharing'*/}
                            <Link to={'https://drive.google.com/uc?export=download&id=1AinAiisk3Pbl_rOqePd46NJpsiDaWOGl'}>
                                <Buttons
